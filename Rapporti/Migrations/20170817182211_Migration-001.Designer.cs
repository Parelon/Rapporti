...
namespace Rapporti.Migrations
{
    ...
    [Migration("20170817182211_Migration-001")]
            ...
            modelBuilder.Entity("Rapporti.Models.Rapporto", b =>
                {
                    ...
                    b.Property<int>("SoggettoUtenteId");
            ...
            modelBuilder.Entity("Rapporti.Models.Rapporto", b =>
                {
                    ...
                    b.HasOne("Rapporti.Models.Utente", "SoggettoUtente")
                        .WithOne()
                        .HasForeignKey("Rapporti.Models.Rapporto", "SoggettoUtenteId");
                });
        }
    }
}
